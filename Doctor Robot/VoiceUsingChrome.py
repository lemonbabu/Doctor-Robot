...
chrome_path='C:\Python37\chromedriver\chromedriver.exe'
...
#        print(text2)
        ...
        if(text!=''):
            if(text==text2):
                ...
                print('off clicked')
                time.sleep(.2)
                #return text2, False #use this to take bangla
                ...
                return driver.find_element_by_xpath('''/html/body/div[2]/div[1]/div[2]/div[1]/div[1]/div[2]/div[3]/div[1]/div[2]/div/span[1]/span''').get_attribute('innerHTML'), False
